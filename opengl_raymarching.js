...
// include: /tmp/tmpz0mw6xhy.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './opengl_raymarching.data';
      var REMOTE_PACKAGE_BASE = 'opengl_raymarching.data';
...
Module['FS_createPath']("/", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./opengl_raymarching.data');

      };
      Module['addRunDependency']('datafile_./opengl_raymarching.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/frag.glsl", "start": 0, "end": 2652}, {"filename": "/shaders/vert.glsl", "start": 2652, "end": 2997}], "remote_package_size": 2997});

  })();

// end include: /tmp/tmpz0mw6xhy.js
// include: /tmp/tmp2dyihyq4.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp2dyihyq4.js
// include: /tmp/tmpz02bfy32.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpz02bfy32.js
...
var ASM_CONSTS = {
  129773: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 129920: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
